...
AFTER_SALES_TEMPLATES = {
    "refund":
    "亲，理解您的情况。关于退款，请您先发起退款申请，我们会尽快审核～",
    "return":
    "退货流程：① 在订单页面发起退货申请 ② 填写退货原因 ③"
    "寄回商品并填写运单号 ④ 我们收到后 48 小时内处理退款 🙏",
    "complaint":
    "非常抱歉给您带来不好的体验！我们会认真处理您的反馈，"
    "请您详细描述一下问题，我来帮您跟进～",
    "damage":
    "啊，商品有损坏？实在抱歉！请拍照发我看看损坏情况，"
    "我们会按照实际情况给您处理退换货或补偿～😊",
    "exchange":
    "好的，可以换货的。请您先发起换货申请，寄回原商品，"
    "我们在收到后尽快安排发出新的～",
    "dispute":
    "亲，您先别急，我来帮您查看具体情况。如果是我们的问题，"
    "一定给您妥善处理！",
    "wrong_item":
    "发错货了？非常抱歉！请拍照发给我，我马上给您重新补发正确的商品～",
    "delay":
    "抱歉让您久等了！我帮您催促一下物流，同时也为您争取一个小补偿。",
}
...
class AfterSalesAgent(BaseAgent):
    ...
    def can_handle(self, message: Message, session: Session) -> float:
        ...
        after_sales_keywords = [
            "退货", "退款", "换货", "投诉", "差评", "曝光", "举报",
            "坏了", "破损", "坏了", "有问题", "发错", "不满意",
            "退钱", "退掉", "退货退款", "退款退货", "漏发", "少发",
            "假货", "歪货", "劣质", "太差", "上当", "被骗",
            "差评", "给差评", "投诉你", "找客服", "人工客服",
            "物流", "还没到", "好久", "等太久", "延迟", "运输",
        ]
